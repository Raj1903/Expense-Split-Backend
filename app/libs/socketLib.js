...
let setServer = (server) => {
    ...
    */
            ...
            */
                    ...
                    let setUserOnline = redisLib.setANewOnlineUserInHash("onlineUsersListExpense", key, value, (err, result) => {
                        if (err) {
                            console.log(`some error occurred`)
                        } else {
                            // getting online users list.

                            redisLib.getAllUsersInAHash('onlineUsersListExpense', (err, result) => {
        ...
        socket.on('disconnect', () => {
            ...
            */
            ...
            if (socket.userId) {
                redisLib.deleteUserFromHash('onlineUsersListExpense', socket.userId)
                redisLib.getAllUsersInAHash('onlineUsersListExpense', (err, result) => {
                    if (err) {
                        console.log(err)
                    } else {
