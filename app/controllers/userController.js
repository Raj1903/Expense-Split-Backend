                        ...
                        newUser.save((err, newUser) => {
                            if (err) {
                                ...
                                let sendEmailOptions = {
                                    ...
                                    subject: 'Welcome to Expense Split Application ',
                                    html: `<b> Dear ${newUserObj.firstName}</b><br>
                                        <br>Welcome to <b>Expense Split Application App</b> <br>
                                        Welcome to the expense apli application.Now share your bill among your self.<br>
            ...
            UserModel.updateOne({ email: req.body.email }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        subject: 'Reset Password for Expense Application ',
        ...
        return new Promise((resolve, reject) => {
            ...
            UserModel.update({ userId: userDetails.userId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        email: userDetails.email,
                        subject: 'Password Updated for Expense Split Application ',
                        html: `<h4> Hi ${userDetails.firstName}  ${userDetails.lastName}</h4>
                        <p>
                            Password updated successfully.
                        </p>
                        <h3> Thanks for using Expense Split Application. Hope you have a good day. </h3>
                                    `
                    }
        ...
        return new Promise((resolve, reject) => {
            ...
            UserModel.update({ userId: userDetails.userId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        email: userDetails.email,
                        subject: 'Your password is get updated',
                        html: `<h4> Hi ${userDetails.firstName}  ${userDetails.lastName}</h4>
                        <p>
                            Password updated successfully hope you enjoying the application.
                        </p>
                        <h3> Thanks for using Expense Split </h3>
                                    `
                    }
